...
fun Document.connectionData(): RemoteConnectionData {
    return object : RemoteConnectionData {
        override val database: String = getString("database")!!
        override val host: String = getString("host")!!
        override val password: String = getString("password")!!
        override val port: Int = getInt("port")!!
        override val user: String = getString("username")!!
    }
}
