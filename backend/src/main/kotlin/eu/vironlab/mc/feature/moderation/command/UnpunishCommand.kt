...
package eu.vironlab.mc.feature.moderation.command
...
import eu.vironlab.mc.feature.moderation.ManagerModerationFeature
...
class UnpunishCommand(val punishFeature: ManagerModerationFeature, val messageConfig: ModerationMessageConfig) :
    ICommandHandler {
...
class UnpunishListIds : ICommandSuggestionProvider {
    ...
    companion object {
        @JvmStatic
        lateinit var punishFeature: ManagerModerationFeature
    }
