...
import eu.vironlab.mc.feature.moderation.PunishReason
...
class PacketGetPunishReason() : JsonPacket() {
    ...
    override suspend fun handle(connection: IConnection): ICommunicationPromise<PunishReason> {
        ...
        return CommunicationPromise.ofNullable(ManagerPacketModerationConstant.moderationFeature.getReason(id), NullPointerException("This reason does not exists"))
    }
}