...
package eu.vironlab.mc.feature.punishment.service
...
class DefaultServicePunishmentFeature : ServicePunishmentFeature {

    val messages: PunishmentMessageConfig
    val periodFormatter: PeriodFormatter

    init {
        this.messages = CloudPlugin.instance.connectionToManager.sendQuery<PunishmentMessageConfig>(
